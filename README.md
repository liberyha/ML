...
## Added by Boyi Li
- 2025.07.22：优化后的模型在prompt_encoder.py和train_update.py中，其余模型结构与medsam原始模型相同。
- 2025.07.23：东北大学医学影像实验室肺部标注数据集受限无法公开，敬请谅解；
- 2025.07.23：MICCAI数据集与实验过程中使用的模型pth文件在 https://pan.baidu.com/s/1KF_4SYgYWtTaKvR37Kjskg?pwd=y77m 提取码: y77m 
